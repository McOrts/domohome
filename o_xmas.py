...
logging.basicConfig(filename='/home/pi/o_xmas.log',
  level=logging.DEBUG,
...
GPIO.setup(config['domohome_xmas']['gpio_pin_output'], GPIO.OUT)
GPIO.output(config['domohome_xmas']['gpio_pin_output'], GPIO.HIGH)
...
#	print("Connected with result code "+str(rc))
	...
	topic = config['domohome_xmas']['topic']
...
def on_message(client, userdata, msg):
	if str(msg.payload) == 'on':
		...
		GPIO.output(config['domohome_xmas']['gpio_pin_output'], GPIO.LOW)
	else:
		print(str(msg.payload))
		GPIO.output(config['domohome_xmas']['gpio_pin_output'], GPIO.HIGH)
